...
exports.DocsController = exports.DocsService = void 0;
...
let DocsService = class DocsService {
    ...
    findByProject(projectId) { return this.repo.find({ where: { projectId }, order: { updatedAt: 'DESC' } }); }
...
exports.DocsService = DocsService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(entities_1.Doc)),
...
], DocsController.prototype, "findByProject", null);
__decorate([
    (0, common_1.Get)(':id'),
